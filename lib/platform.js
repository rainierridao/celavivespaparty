...
async function markSpecialPaymentPaid(event, reference, shouldMarkPaid) {
  ...
  if (currentStatus === nextStatus) {
    return { message: `Payment is already marked ${nextStatus.toLowerCase()}.`, emailSent: false };
  }
  ...
  if (!shouldMarkPaid) {
    return { message: 'Payment moved back to pending.', emailSent: false };
  }
  ...
  return {
    message: emailResult.sent
      ...
      : 'Marked as paid, but the confirmation email could not be sent. Check your email settings.',
    emailSent: emailResult.sent
  };
}
